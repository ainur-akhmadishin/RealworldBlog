    ...
    <div>
      ...
      <section className={classes.SignUp}>
        ...
        <form className={classes.Form} onSubmit={handleSubmit(registration)}>
          <label htmlFor="username" className={classes['SignUp--label']}>
            Username
          </label>
          <input
            type="text"
          ...
          <label htmlFor="email" className={classes['SignUp--label']}>
            Email address
          </label>
          <input
            type="text"
          ...
          <label htmlFor="password" className={classes['SignUp--label']}>
            Password
          </label>
          <input
            type="password"
          ...
          <label htmlFor="confirmPassword" className={classes['SignUp--label']}>
            Repeat Password
          </label>
          <input
            type="password"
