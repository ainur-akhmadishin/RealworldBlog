...
const UserEdit = ({ error, userData, userUpdate, loading, isEdit }) => {
  ...
  const getUsername = userData.username ? userData.username : '';
  ...
  return (
    <div>
      ...
      <section className={classes.UserEdit}>
        ...
        <form className={classes.Form} onSubmit={handleSubmit(submitUpdate)}>
          <label htmlFor="username" className={classes['UserEdit--label']}>
            Username
          </label>
          <input
          ...
          <label htmlFor="email" className={classes['UserEdit--label']}>
            Email address
          </label>
          <input
            type="text"
          ...
          <label htmlFor="password" className={classes['UserEdit--label']}>
            New password
          </label>
          <input
            type="password"
          ...
          <label htmlFor="avatar" className={classes['UserEdit--label']}>
            Avatar image (url)
          </label>
          <input
            className={classes['UserEdit--input']}
          ...
          <button type="submit" className={classes['UserEdit--button']}>
            Save
          </button>
        </form>
      </section>
