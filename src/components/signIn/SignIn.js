    ...
    <div>
      ...
      <section className={classes.SignIn}>
        ...
        <form className={classes.Form} onSubmit={handleSubmit(authentication)}>
          <label htmlFor="email-login" className={classes['SignIn--label']}>
            Email address
          </label>
          <input
            type="email"
            className={classes['SignIn--input']}
          ...
          <label htmlFor="password" className={classes['SignIn--label']}>
            Password
          </label>
          <input
            type="password"
          ...
          <button type="submit" className={classes['SignIn--button']}>
            Login
          </button>
        </form>
